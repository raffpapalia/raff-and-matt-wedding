  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-[2rem] border border-white/10 bg-slate-950 p-8 shadow-2xl">
        <p className="text-sm uppercase tracking-[0.3em] text-emerald-200/70">Choose templates</p>
        ...
        <div className="mt-6">
          <label className="mb-2 block text-xs uppercase tracking-[0.25em] text-sky-300/80" htmlFor="chooser-email-template">
            Email template
          </label>
          {activeEmailTemplates.length === 0 ? (
            ...
            <select
              ...
              className="w-full rounded-2xl border border-white/10 bg-slate-900/90 px-4 py-2.5 text-sm text-white outline-none transition focus:border-sky-400"
            >
        ...
        <div className="mt-5">
          <label className="mb-2 block text-xs uppercase tracking-[0.25em] text-violet-300/80" htmlFor="chooser-sms-template">
            SMS template
          </label>
          {activeSmsTemplates.length === 0 ? (
            ...
            <select
              ...
              className="w-full rounded-2xl border border-white/10 bg-slate-900/90 px-4 py-2.5 text-sm text-white outline-none transition focus:border-violet-400"
            >
