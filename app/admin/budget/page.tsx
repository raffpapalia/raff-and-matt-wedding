...
import type { BudgetItem, BudgetLineItem, BudgetPayment, BudgetSettings } from '@/lib/supabase';
import BudgetClient from './BudgetClient';

export default async function AdminBudgetPage() {
  await requireAdminAuth();

  const [itemsRes, linesRes, paymentsRes, settingsRes, attendingRes, expectedRes] = await Promise.all([
